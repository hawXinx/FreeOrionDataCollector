...
data = read.csv("speciesMeanWinning.csv", sep = ";")
...
data_results = data.frame(data$Species, data$Entries, data$Mean, data$Mean_normalized, 
...
write.table(data_results, file = "speciesWinningSignificance.csv", sep = ";", row.names = FALSE)
